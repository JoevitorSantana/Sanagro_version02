            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Minhas Contas à Pagar</h1>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="row g-3" action="php/cadcontas.php" method="POST">
                                            <div class="mb-3">
                                            ...
                                            <?php
                                                $iduser = $_SESSION['id'];
                                                $sql = "select id_providers, pro_name from providers where id='$iduser'";
                                                $query = mysqli_query($conn, $sql);

                                            ?>
                                            <div class="mb-3">
                                                <label for="cFornecedor" class="form-label">Fornecedor</label>
                                                <select name="tFornecedor" class="form-select"
                                                    aria-label="Default select example">
                                                    <option selected>Escolha...</option>
                                                    <?php while($row = mysqli_fetch_assoc($query)){?>
                                                    <option value="<?php echo $row['id_providers'] ?>">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="number" class="form-control" id="prestacao"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" onchange="return onlynumber();" class="form-control" id="valorprestacao"
                        ...
                        <?php
                            ...
                            $iduser = $_SESSION['id'];                                    
                            $sql = "select id_cap, description, value, installments, installment_value, expiration, date_format(expiration,'%d/%m/%Y'), status, pro_name, a.id_providers
                                    from contaapagar a, providers b
                                    where a.id_providers=b.id_providers and a.id = '$iduser'
                            ...
                            <div class="card shadow h-100 py-2" style="border-left:4px solid limegreen;">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1" style="color: limegreen; font-size: 15px;">
                                        ...
                                        <a href="#editArea" class="btn btn-circle" style="color: limegreen;"
                                                        ...
                                                        data-bs-whateverid="<?php echo $row['id_cap'];?>"
                                                        data-bs-whatevernome="<?php echo $row['description'];?>"
                                                        data-bs-whateverfornecedor="<?php echo $row['id_providers'];?>"
                                                    ...
                                                    <?php echo
                                                            "<style>button{background-color:transparent;color:white;border-style:none; border-radius:50px; padding: 5px;}.buttons{text-decoration:none;color:red;}.buttons:hover{color: darkred;}.edit{background-color:limegreen;}</style><button><a class='buttons' href='php/deletecontas.php?id=".$row['id_cap']."'><i class='far fa-trash-alt'></i></a></button>";  
                                                        ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <?php } 
                            $id = $_SESSION['id'];
                            $result_pg = "SELECT COUNT(id_cap) AS num_result FROM contaapagar where id=$id";
                            ...
                            for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++)
                            {
                                if($pag_ant >= 1)
                                {
                                    echo "<a href='contasapagar.php?pagina=$pag_ant'>$pag_ant</a> ";
                                }
                            }
                            ...
                            for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++)
                            {
                                ...
                                {
                                    echo "<a href='contasapagar.php?pagina=$pag_dep'>$pag_dep</a> ";
                                }
                            }
                           
                            echo "<a href='contasapagar.php?pagina=$quantidade_pg'>Ultima</a>";
                            }
            ...
            <div class="modal fade" id="editarea" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="row g-3" action="php/editcontas.php" method="POST">
                                <div class="mb-3">
                                ...
                                <div class="col-md-7">
                                    <label for="cArea" class="form-label">Valor</label>
                                    <input type="text" class="form-control" id="valor" name="tValor"
                                        id="exampleFormControlInput1" placeholder="Exemplo: R$99,00"
                                        onblur="calcular()">
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-6">
                                    <label for="cArea" class="form-label">Valor Total</label>
                                    <input type="text" class="form-control" id="valorprestacao" name="tValorprestacao"
                                        id="exampleFormControlInput1" placeholder="Exemplo: R$99,00">
                                </div>
                                <div class="col-md-4">
                                    <label for="exampleFormControlInput1" class="form-label">Status</label>
