        ...
        <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <!--<h1 class="h3 mb-0 text-gray-800">Minhas Fazendas</h1>-->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Nova Fazenda</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <form class="row g-3" action="./php/cadfazenda.php" method="POST">
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1" class="form-label">Nome da
                                                    Fazenda</label>
                                                <input type="hidden" class="form-control" required name="tUser"
                                                    value="<?php echo $_SESSION['id']; ?>">
                                                <input type="text" class="form-control" required name="tNome"
                                                    id="exampleFormControlInput1" placeholder="Exemplo: Fazenda01">
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1"
                                                    class="form-label">Endereço</label>
                                                <input class="form-control" required name="tEndereco"
                                                    placeholder="Exemplo: Rua Três, nº 21" id="message-text">
                                            </div>
                                            <div class="col-md-7">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <a href="#editArea" class="btn btn-circle" style="color: limegreen;"
                                                ...
                                                data-bs-whateverid="<?php echo $row['id_farm'];?>"
                                            ...
                                            <?php echo
                                                "<style>button{background-color:transparent;color:white;border-style:none; border-radius:50px; padding: 5px;}.buttons{text-decoration:none;color:red;}.buttons:hover{color: darkred;}.edit{background-color:limegreen;}</style><button><a class='buttons' href='php/deletefazenda.php?id=".$row['id_farm']."'><i class='far fa-trash-alt'></i></a></button>";?>                                            
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <?php } 
                            ...
                            for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++)
                            {
                                if($pag_ant >= 1)
                                {
                                    echo "<a href='fazendas.php?pagina=$pag_ant'>$pag_ant</a> ";
                                }
                            }
                            ...
                            for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++)
                            {
                                ...
                                {
                                    echo "<a href='fazendas.php?pagina=$pag_dep'>$pag_dep</a> ";
                                }
                            }
                           
                            echo "<a href='fazendas.php?pagina=$quantidade_pg'>Ultima</a>";
                            }
            ...
            <div class="modal fade" id="editarea" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Editar Fazenda</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form class="row g-3" action="php/editfazenda.php" method="POST">
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Nome da
                                        Fazenda</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="endereco" name="tEndereco"
                                        placeholder="Exemplo: Rua Três, nº 21"></textarea>
                                </div>
                                <div class="col-md-7">
                                    <label for="exampleFormControlInput1" class="form-label">Cidade</label>
