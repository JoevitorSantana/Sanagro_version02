...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar"
            ...
            <!-- Divider -->
            <hr class="sidebar-divider my-0" style="color: #7fe084;">
            ...
            <!-- Divider -->
            <hr class="sidebar-divider" style="color: #7fe084;">
            ...
            <!-- Divider -->
            <hr class="sidebar-divider d-none d-md-block" style="color: #7fe084;">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                            ...
                            <div class="modal-dialog modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="row g-3" action="php/cadfuncionario.php" method="POST">
                                            <div class="mb-3">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <input type="text" oninput="mascara(this)" class="form-control" name="tCpf"
                                                id="cnpj" placeholder="Exemplo: 888.888.888-88">
                                            </div>
                                            <div class="col-md-5">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <input type="text" class="form-control" name="tCargo"
                                                    id="exampleFormControlInput1" placeholder="Exemplo: Colhedor">
                                            </div>
                                            <div class="col-md-7">
                                                <label for="exampleFormControlInput1" class="form-label">Salário</label>
                                                <input type="number" class="form-control" name="tSalario"
                                                    id="exampleFormControlInput1" placeholder="Exemplo: R$999,99">

                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1" class="form-label">Contato</label>
                                                <input type="text" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" class="form-control" name="tCont"
                                                    id="contato" placeholder="Exemplo: (99)9999-9999">
                                            </div>
                                            <div class="col-12">
                                                <?php
                                                    $id = $_SESSION['id'];
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="tAddress"
                                                    ...
                                                    placeholder="Exemplo: Rua Oito nº 999 - São Paulo - SP">
                                            </div>
                                            <div class="col-md-7">
                                                <label for="exampleFormControlInput1" class="form-label">Cidade</label>
                                                <input type="text" class="form-control" required name="tCidade"
                                                    id="exampleFormControlInput1" placeholder="Exemplo: São Paulo">
                                            </div>
                                            <div class="col-md-5">
                                                <label for="exampleFormControlInput1" class="form-label">UF</label>
                                                <select id="medida" name="tUf" required class="form-select">
                    ...
                    <?php
                            ...
                            $id = $_SESSION['id'];
                            $sql2 = "select * from employees where id='$id' order by created_at desc
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" style="font-size: 15px;">
                                                <?php echo $row['office']?></div>
                                        </div>
                                        <div class="col-auto">
                                        <a href="#editArea" class="btn btn-circle" style="color: limegreen;"
                                                        data-bs-toggle="modal" data-bs-target="#editarea"
                                                        data-bs-whateverid="<?php echo $row['id_emp'];?>"
                                                        data-bs-whatevercpf="<?php echo $row['cpf'];?>"
                                                        data-bs-whatevernome="<?php echo $row['name'];?>"
                                                        data-bs-whatevercargo="<?php echo $row['office'];?>"
                                                        data-bs-whateversexo="<?php echo $row['gender'];?>"
                                                        ...
                                                        data-bs-whateversalario="<?php echo $row['payment'];?>"
                                                        data-bs-whateverendereco="<?php echo $row['address'];?>">
                                                        <i class="far fa-edit"></i>
                                                    </a>

                                                    <?php echo
                                                            "<style>button{background-color:transparent;color:white;border-style:none; border-radius:50px; padding: 5px;}.buttons{text-decoration:none;color:red;}.buttons:hover{color: darkred;}.edit{background-color:limegreen;}</style><button><a class='buttons' href='php/deletefuncionario.php?id=".$row['id_emp']."'><i class='far fa-trash-alt'></i></a></button>";  
                                                        ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <?php } 
                            $id = $_SESSION['id'];
                            $result_pg = "SELECT COUNT(id_emp) AS num_result FROM employees where id=$id";
                            ...
                            if ($row_pg['num_result'] == 0){
                                echo "<h1 class='h3 mb-0 text-gray'>Você não possui nenhum funcionário cadastrado!</h1><br>";
                            ...
                            $max_links = 2;
                            echo "<style>a { text-decoration: none; color: inherit; }a:hover{text-decoration: none; color: limegreen;}</style><a class='link' href='funcionarios.php?pagina=1'>Primeira</a> ";
                           
                            for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++)
                            {
                                if($pag_ant >= 1)
                                {
                                    echo "<a href='funcionarios.php?pagina=$pag_ant'>$pag_ant</a> ";
                                }
                            }
                            ...
                            for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++)
                            {
                                ...
                                {
                                    echo "<a href='funcionarios.php?pagina=$pag_dep'>$pag_dep</a> ";
                                }
                            }
                           
                            echo "<a href='funcionarios.php?pagina=$quantidade_pg'>Ultima</a>";
                            }
            ...
            <div class="modal fade" id="editarea" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="row g-3" action="php/editfuncionario.php" method="POST">
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Nome
                                        Completo</label>
                                ...
                                <div class="col-md-7">
                                    <label for="exampleFormControlInput1" oninput="mascara(this)" class="form-label">CPF</label>
                                    <input type="text" class="form-control" name="tCpf" id="cpf"
                                        placeholder="Exemplo: 888.888.888-88">
                                </div>
                                <div class="col-md-5">
                                    <label for="inputState" class="form-label">Sexo</label>
                                    <select id="sexo" name="tType" class="form-select">
                                        <option value="Masculino">Masculino</option>
                                        <option value="Feminino">Feminino</option>
                                    </select>
                                </div>
                                <div class="col-md-5">
                                    <label for="exampleFormControlInput1" class="form-label">Cargo</label>
                                    <input type="text" class="form-control" name="tCargo" id="cargo"
                                        placeholder="Exemplo: Colhedor">
                                </div>
                                <div class="col-md-7">
                                    <label for="exampleFormControlInput1" class="form-label">Salário</label>
                                    <input type="number" class="form-control" id="salario" name="tSalario"
                                        id="exampleFormControlInput1" placeholder="Exemplo: R$999,99">

                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Contato</label>
                                    <input type="text" class="form-control" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" name="tCont" id="contato"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="endereco" name="tAddress"
                                        ...
                                        placeholder="Exemplo: Rua Oito nº 999 - São Paulo - SP">
                                            ...
                                            <div class="col-md-7">
                                                <label for="exampleFormControlInput1" class="form-label">Cidade</label>
                                                <input type="text" class="form-control" required id="cidade" name="tCidade"
                                                    id="exampleFormControlInput1" placeholder="Exemplo: São Paulo">
                                            </div>
                                            <div class="col-md-5">
                                                <label for="exampleFormControlInput1"  class="form-label">UF</label>
                                                <select id="uf" name="tUf" required class="form-select">
                                                    <option value="AC">Acre</option>
                                                    <option value="AL">Alagoas</option>
                                                    <option value="AP">Amapá</option>
                                                    <option value="AM">Amazonas</option>
            ...
            exampleModal.addEventListener('show.bs.modal', function(event) {
                ...
                var recipientcargo = button.getAttribute('data-bs-whatevercargo')
                var recipientcontato = button.getAttribute('data-bs-whatevercontato')
                var recipientsalario = button.getAttribute('data-bs-whateversalario')
                var recipientendereco = button.getAttribute('data-bs-whateverendereco')
                var recipientcpf = button.getAttribute('data-bs-whatevercpf')
                var recipientsexo = button.getAttribute('data-bs-whateversexo')
                ...
                var cpf = exampleModal.querySelector('#cpf')
                var cargo = exampleModal.querySelector('#cargo')
                var contato = exampleModal.querySelector('#contato')
                var salario = exampleModal.querySelector('#salario')
                var endereco = exampleModal.querySelector('#endereco')
                var sexo = exampleModal.querySelector('#sexo')
                ...
                cpf.value = recipientcpf
                cargo.value = recipientcargo
                contato.value = recipientcontato
                salario.value = recipientsalario
                endereco.value = recipientendereco
                sexo.value = recipientsexo
