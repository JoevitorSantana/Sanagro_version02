    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Minhas Contas à Receber</h1>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="row g-3" action="php/cadrecebimento.php" method="POST">
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1"
                                                    class="form-label">Descrição</label>
                                                <input required type="hidden" class="form-control" id="id" name="tUser"
                                                    value="<?php echo $_SESSION['id']; ?>">
                                                <input type="text" class="form-control" id="nome" required name="tNome"
                                                    id="exampleFormControlInput1" placeholder="Exemplo: Óleo Diesel">
                                            </div>
                                            <?php
                                                $iduser = $_SESSION['id'];
                                                $sql = "select id_customer, name from customers where id='$iduser'";
                                                $query = mysqli_query($conn, $sql);

                                            ?>
                                            <div class="mb-3">
                                                <label for="cFornecedor" class="form-label">Cliente</label>
                                                <select required name="tFornecedor" class="form-select"
                                            ...
                                            <script>
                                                function calcular() {
                                                    ...
                                                    var valor2 = parseFloat(document.getElementById('prestacao').value, 10);
                                                    (document.getElementById('valorprestacao').value = (valor1 / valor2));
                                                }
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <input type="text" required onkeypress="return onlynumber();" class="form-control" id="valor" name="tValor"
                                                    id="exampleFormControlInput1" placeholder="Exemplo: R$99,00"
                                                    onblur="calcular()">
                                            </div>
                                            <div class="col-md-4">
                                                <label for="cArea" class="form-label">Prestações</label>
                                                <input type="number" required class="form-control" id="prestacao"
                                                    name="tPrestacao" id="exampleFormControlInput1"
                                                    placeholder="Exemplo: 2" onblur="calcular()">
                                            </div>
                                            
                                            <div class="col-md-6">
                                                <label for="cArea" class="form-label">Valor Total</label>
                                                <input type="text" maxlength="10" required onchange="return onlynumber();" class="form-control" id="valorprestacao"
                                                    name="tValorprestacao" id="exampleFormControlInput1"
                                                    placeholder="Exemplo: R$99,00">
                                            </div>
                                            <div class="col-md-4">
                                                <label for="exampleFormControlInput1" class="form-label">Status</label>
                                                <select id="status" name="tStatus" required class="form-select">
                                                    <option selected>Escolha...</option>
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <input required type="date" id="fim" name="tDtend"
                    ...
                    <?php
                            ...
                            $iduser = $_SESSION['id'];                                    
                            $sql = "select id_car, description, value, installments, installment_value, expiration, date_format(expiration,'%d/%m/%Y'), status, name, a.id_customer
                                            from contaareceber a, customers b
                                            where a.id_customer=b.id_customer and a.id = '$iduser'
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div cclass="text-xs font-weight-bold text-uppercase mb-1" style="color: limegreen; font-size: 15px;">
                                                <?php echo $row['description']?> (<?php echo $row['status']?>)</div>
                                        ...
                                        <a href="#editArea" class="btn btn-circle" style="color: limegreen;"
                                                        ...
                                                        data-bs-whateverid="<?php echo $row['id_car'];?>"
                                                        data-bs-whatevernome="<?php echo $row['description'];?>"
                                                        data-bs-whateverfornecedor="<?php echo $row['id_customer'];?>"
                                                        data-bs-whatevervalor="<?php echo $row['value'];?>"
                                                        data-bs-whateverprestacao="<?php echo $row['installments'];?>"
                                                        data-bs-whatevervencimento="<?php echo $row['expiration'];?>"
                                                        data-bs-whateverstatus="<?php echo $row['status'];?>"
                                                        data-bs-whatevervalorprestacao="<?php echo $row['installment_value'];?>">
                                                        <i class="far fa-edit"></i>
                                                    </a>


                                                    <?php echo
                                                            "<style>button{background-color:transparent;color:white;border-style:none; border-radius:50px; padding: 5px;}.buttons{text-decoration:none;color:red;}.buttons:hover{color: darkred;}.edit{background-color:limegreen;}</style><button><a class='buttons' href='php/deleterecebimento.php?id=".$row['id_car']."'><i class='far fa-trash-alt'></i></a></button>";  
                                                        ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <?php } 
                            $id = $_SESSION['id'];
                            $result_pg = "SELECT COUNT(id_car) AS num_result FROM contaareceber where id=$id";
                            ...
                            for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++)
                            {
                                if($pag_ant >= 1)
                                {
                                    echo "<a href='contasareceber.php?pagina=$pag_ant'>$pag_ant</a> ";
                                }
                            }
                            ...
                            for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++)
                            {
                                ...
                                {
                                    echo "<a href='contasareceber.php?pagina=$pag_dep'>$pag_dep</a> ";
                                }
                            }
                           
                            echo "<a href='contasareceber.php?pagina=$quantidade_pg'>Ultima</a>";
                            }
            ...
            <div class="modal fade" id="editarea" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="row g-3" action="php/editrecebimento.php" method="POST">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="cFornecedor" class="form-label">Cliente</label>
                                    <select name="tFornecedor" id="fornecedor" class="form-select" aria-label="Default select example">
                                        <option selected>Escolha...</option>
                                        <?php while($row = mysqli_fetch_assoc($query)){?>
                                        <option value="<?php echo $row['id_customer'] ?>">
                                            <?php echo $row['name']?></option>
                                ...
                                <div class="col-md-4">
                                    <label for="cArea" class="form-label">Prestações</label>
                                    <input type="number" class="form-control" id="prestacao" name="tPrestacao"
                                        id="exampleFormControlInput1" placeholder="Exemplo: 2" onblur="calcular()">
                                </div>

                                <div class="col-md-6">
                                    <label for="cArea" class="form-label">Valor Total</label>
                                    <input type="text" onkeypress="return onlynumber();" class="form-control" id="valorprestacao" name="tValorprestacao"
                                        id="exampleFormControlInput1" placeholder="Exemplo: R$99,00">
                                </div>
                                <div class="col-md-4">
                                    <label for="exampleFormControlInput1" class="form-label">Status</label>
                                    <select id="status" name="tStatus" class="form-select">
                                        <option selected>Escolha...</option>
                                        <option value="Pendente">Pendente</option>
                                        <option value="Pago">Pago</option>
                                    </select>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input type="date" id="vencimento" name="tDtend"
                                        style="border: grey; outline: none; color: grey;">
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal">Cancelar</button>
            ...
            exampleModal.addEventListener('show.bs.modal', function(event) {
                ...
                var recipientprestacao = button.getAttribute('data-bs-whateverprestacao')
                var recipientvencimento = button.getAttribute('data-bs-whatevervencimento')
                var recipientfornecedores = button.getAttribute('data-bs-whateverfornecedor')
                var recipientvalorprestacao = button.getAttribute('data-bs-whatevervalorprestacao')
                ...
                var fornecedor = exampleModal.querySelector('#fornecedor')
                var prestacao = exampleModal.querySelector('#prestacao')
                var valorprestacao = exampleModal.querySelector('#valorprestacao')
                var vencimento = exampleModal.querySelector('#vencimento')
                ...
                fornecedor.value = recipientfornecedores
                prestacao.value = recipientprestacao
                valorprestacao.value = recipientvalorprestacao
                vencimento.value = recipientvencimento
