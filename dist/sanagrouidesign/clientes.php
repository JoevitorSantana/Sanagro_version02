            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Meus Clientes</h1>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="row g-3" action="php/cadclientes.php" method="POST">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="nome" name="tNome"
                                                    id="exampleFormControlInput1" placeholder="Exemplo: Carlos Alberto">
                                            </div>
                                            <?php
                                                $id = $_SESSION['id'];
                                            ...
                                            <div class="col-md-6">
                                                <label for="cArea" class="form-label">CPF</label>
                                                <input type="text" oninput="mascara(this)" class="form-control" id="cnpj" name="tCnpj"
                                                    id="exampleFormControlInput1" placeholder="Digite um CPF">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="exampleFormControlInput1" class="form-label">Contato</label>
                                                <input type="text" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" class="form-control" id="contato" name="tCont"
                        ...
                        <?php
                            ...
                            $iduser = $_SESSION['id'];                                    
                            $sql = "select id_customer, a.name, contact, a.address, a.city, a.uf, a.id_farm, cpf
                                    from customers a, farm b
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <a href="#editArea" class="btn btn-circle" style="color: limegreen;"
                                                    ...
                                                    <?php echo
                                                            "<style>button{background-color:transparent;color:white;border-style:none; border-radius:50px; padding: 5px;}.buttons{text-decoration:none;color:red;}.buttons:hover{color: darkred;}.edit{background-color:limegreen;}</style><button><a class='buttons' href='php/deleteclientes.php?id=".$row['id_customer']."'><i class='far fa-trash-alt'></i></a></button>";  
                                                        ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <?php } 
                            $id = $_SESSION['id'];
                            $result_pg = "SELECT COUNT(id_customer) AS num_result FROM customers where id=$id";
                            ...
                            if ($row_pg['num_result'] == 0){
                                echo "<h1 class='h3 mb-0 text-gray'>Você não possui nenhum cliente cadastrado!</h1><br>";
                            ...
                            for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++)
                            {
                                if($pag_ant >= 1)
                                {
                                    echo "<a href='clientes.php?pagina=$pag_ant'>$pag_ant</a> ";
                                }
                            }
                            ...
                            for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++)
                            {
                                ...
                                {
                                    echo "<a href='clientes.php?pagina=$pag_dep'>$pag_dep</a> ";
                                }
                            }
                           
                            echo "<a href='clientes.php?pagina=$quantidade_pg'>Ultima</a>";
                            }
            ...
            <div class="modal fade" id="editarea" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="row g-3" action="php/editclientes.php" method="POST">
                                <div class="mb-3">
