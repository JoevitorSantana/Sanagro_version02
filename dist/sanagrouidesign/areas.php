    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Nova Área</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <form class="row g-3" action="php/cadarea.php" method="POST">
                                            <div class="mb-3">
                                                ...
                                                required  id="exampleFormControlInput1" placeholder="Exemplo: Area01">
                                            </div>
                                            <div class="col-md-7">
                                                <script>
                                                ...
                                                <label for="exampleFormControlInput1" class="form-label">Tamanho da
                                                    Área</label>
                                                <input type="text" onkeypress="return onlynumber();" class="form-control" name="tSize"
                                                required id="exampleFormControlInput1" placeholder="Exemplo: 1.024,70">
                                            </div>
                                            <div class="col-md-5">
                                                <label for="inputState" class="form-label">Unidade de Medida</label>
                                                <select id="inputState" name="tUnit" class="form-select">
                                        ...
                                        ?>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input required class="btn btn-primary"
                        ...
                        <?php
                            ...
                            $id = $_SESSION['id'];
                            $sql2 = "select id_area, ar_name, size, metric, a.id_farm, name , ar_status, a.created_at
                            from area02 a, farm b
                            where a.id_farm=b.id_farm and a.id='$id'
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div cclass="text-xs font-weight-bold text-uppercase mb-1" style="color: limegreen;">
                                                <?php echo $row['ar_name']?> (<?php echo $row['ar_status']?>)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php echo $row['size']?> <?php echo $row['metric']?></div>
                                        </div>
                                        <div class="col-auto">
                                            <a href="#editArea" class="btn btn-circle" style="color: limegreen;"
                                                data-bs-toggle="modal" data-bs-target="#editarea"
                                                data-bs-whateverid="<?php echo $row['id_area'];?>"
                                                data-bs-whatevernome="<?php echo $row['ar_name'];?>"
                                                ...
                                                data-bs-whatevertamanho="<?php echo $row['size'];?>"
                                                data-bs-whateverstatus="<?php echo $row['ar_status'];?>">
                                                <i class="far fa-edit"></i>
                                            </a>


                                            <?php echo
                                                "<style>button{background-color:transparent;color:white;border-style:none; border-radius:50px; padding: 5px;}.buttons{text-decoration:none;color:red;}.buttons:hover{color: darkred;}.edit{background-color:limegreen;}</style><button><a class='buttons' href='php/deletearea.php?id=".$row['id_area']."'><i class='far fa-trash-alt'></i></a></button>";?>                                            
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <?php } 
                            ...
                            $id = $_SESSION['id'];
                            $result_pg = "SELECT COUNT(id_area) AS num_result FROM area02 where id=$id";
                            ...
                            if ($row_pg['num_result'] == 0){
                                echo "<h1 class='h3 mb-0 text-gray'>Você não possui nenhuma Área cadastrada,</h1><br>";
                                echo "<h1 class='h3 mb-0 text-gray'>Mas primeiro você deve cadastrar uma fazenda!</h1><br>";
                            ...
                            for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++)
                            {
                                if($pag_ant >= 1)
                                {
                                    echo "<a href='areas.php?pagina=$pag_ant'>$pag_ant</a> ";
                                }
                            }
                            ...
                            for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++)
                            {
                                ...
                                {
                                    echo "<a href='areas.php?pagina=$pag_dep'>$pag_dep</a> ";
                                }
                            }
                           
                            echo "<a href='areas.php?pagina=$quantidade_pg'>Ultima</a>";
                            }
            ...
            <div class="modal fade" id="editarea" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="row g-3" action="php/editarea.php" method="POST">
                                <div class="col-md-6">
                                    <label for="cArea" class="form-label">Status</label>
                                    <input type="text" class="form-control" readonly id="status">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Nome da Área</label>
                                    <input type="hidden" class="form-control" value="<?php echo $_SESSION['id']; ?>" name="tCod" id="id">
                                    <input type="text" class="form-control" name="tNome" id="nome"
                                        placeholder="Exemplo: Area01">
                                </div>

                                <div class="col-md-7">
                                    <label for="exampleFormControlInput1" class="form-label">Tamanho da Área</label>
                                    <input type="text" onkeypress="return onlynumber();" class="form-control" name="tSize" id="tamanho"
                                        placeholder="Exemplo: 1.024,70">
                                </div>
                                <div class="col-md-5">
                                    <label for="inputState" class="form-label">Unidade de Medida</label>
                                ...
                                <div class="col-12">
                                    <?php
                                        $id = $_SESSION['id'];
                                            ...
                                            $query3 = mysqli_query($conn, $sql)
                                        ?>
                                    <label for="tFarm" class="form-label">Fazenda</label>
                                    <select id="fazenda" name="cFarm" class="form-select"
                                        aria-label="Default select example">
                                        <option selected>Escolha...</option>
                                        <?php while($farm = mysqli_fetch_assoc($query3)){?>
                                        <option value="<?php echo $farm['id_farm'] ?>"><?php echo $farm['name']?>
                                        </option>
                                        <?php } ?>
                                    </select>
                                </div>
            ...
            exampleModal.addEventListener('show.bs.modal', function(event) {
                ...
                var recipienttamanho = button.getAttribute('data-bs-whatevertamanho')
                //var recipientmedida = button.getAttribute('data-bs-whatevermedida')
                ...
                var tamanho = exampleModal.querySelector('#tamanho')
