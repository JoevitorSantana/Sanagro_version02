...
$farmName = farmName();
$pessoas = selectContaReceber();

$pdf = new FPDF();
$pdf->AliasNbPages();
$pdf->AddPage();
$pdf->SetFont('Arial','B',16);
$pdf->Cell(190,10,utf8_decode('Relatório de Contas à Receber'),1,0,"C");
$pdf->Ln(10);
...
foreach ($pessoas as $pessoa){
    ...
    $pdf->Cell(30,7,utf8_decode($pessoa["name"]),0,"C");
...
$pdf->Output("Contas a Receber.pdf","D");
